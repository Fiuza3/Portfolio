<template>
	<div
		class="projetos py-20 bg-gradient-to-b from-primary-950 via-primary-600 to-primary-950"
	>
		<div class="container mx-auto px-6">
			...
			<div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
				<div
					...
					:key="projeto.id"
					class="bg-primary-50 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
				>
					<!-- Imagem do Projeto -->
					...
					<!-- Conteúdo do Card -->
					<div class="p-6">
						<h3 class="text-xl font-bold text-primary-50 mb-3">
							{{ projeto.titulo }}
						</h3>
						<p class="text-primary-50 mb-4 line-clamp-3">
							{{ projeto.descricao }}
						</p>
						...
						<div class="flex justify-between items-center">
							<div class="flex gap-4">
								<a
									...
									target="_blank"
									class="flex items-center text-primary-50 hover:text-primary-100 font-medium transition-colors"
								>
									<svg
										class="w-4 h-4 mr-1"
										fill="currentColor"
			...
			<div class="text-center mt-16">
				<div
					class="bg-gradient-to-b from-primary-50 to-primary-900 rounded-2xl p-8 text-white"
				>
