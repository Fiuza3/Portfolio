<template>
	<footer class="bg-primary-900 text-white py-6">
		<div class="container mx-auto px-6">
			<div class="grid md:grid-cols-3 gap-8">
				<div>
					...
					<p class="text-gray-300 mb-4">
						Desenvolvedor apaixonado por criar soluções digitais inovadoras e
						funcionais.
					</p>
			...
			<div class="border-t border-gray-700 mt-4 pt-4 text-center text-gray-300">
				<p class="text-center">
					&copy; {{ new Date().getFullYear() }} Portfólio Profissional. Todos os direitos reservados a Marcus Vinicius Fiuza Silva
				</p>
			</div>
		</div>
	</footer>
